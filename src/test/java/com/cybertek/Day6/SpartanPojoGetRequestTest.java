...
import com.cybertek.utilies.SpartanTestBase;
...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void test3() {
        ...
        System.out.println("first spartan = " + searchResult.getContent().get(0).getName());


    }

    @DisplayName("Get spartan/search and save List<Spartan>")
    @Test
    public void test4() {
